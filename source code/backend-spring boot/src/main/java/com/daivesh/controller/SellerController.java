...
import com.daivesh.repository.VerificationCodeRepository;
import com.daivesh.response.ApiResponse;
import com.daivesh.response.AuthResponse;
import com.daivesh.service.*;
import com.daivesh.service.impl.CustomeUserServiceImplementation;
import com.daivesh.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "daivesh Bazaar Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Daivesh Bazaar Email Verification Code";
        String text = "Welcome to daivesh Bazaar, verify your account using this link ";
